...
!(function (e, t) {
  ...
  function k(e, t, i) {
    ...
    return (
      ...
      v(i) &&
        ((h = !!i.leading),
        (l = (d = "maxWait" in i) ? w(E(i.maxWait) || 0, t) : l),
  ...
  var D = (function () {
    function t(e) {
      ...
      i(this, t),
          ...
          "x" === s.draggedAxis &&
            (a =
              s.isRtl && t.getRtlHelpers().isScrollOriginAtZero
                ? a - (r + l.size)
                : a),
            (s.contentWrapperEl[s.axis[s.draggedAxis].scrollOffsetAttr] = a);
        }),
        ...
        (this.options = T(T({}, t.defaultOptions), r)),
        (this.classNames = T(
          {
      ...
      (l = [
          ...
          value: function () {
            ...
            if (this.axis[e].isOverflowing) {
              ...
              (a =
                "x" === e &&
                this.isRtl &&
                t.getRtlHelpers().isScrollingToNegative
                  ? -a + (s - l.size)
                  : a),
        ...
        },
        {
          ...
          value: function (e) {
            ...
            (this.axis[t].dragOffset = l - r.rect[this.axis[t].offsetAttr]),
              (this.draggedAxis = t),
