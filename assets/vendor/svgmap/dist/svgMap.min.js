...
function svgMapWrapper(t) {
  ...
  return (
    ...
    (l.prototype.applyData = function (L) {
      var a = null,
        o = null;
      Object.keys(L.values).forEach(function (l) {
        l = parseInt(L.values[l][L.applyData], 10);
        (a = null === a ? l : a) < l && (a = l),
          l < (o = null === o ? l : o) && (o = l);
      }),
        L.data[L.applyData].thresholdMax &&
          (a = Math.min(a, L.data[L.applyData].thresholdMax)),
        L.data[L.applyData].thresholdMin &&
          (o = Math.max(o, L.data[L.applyData].thresholdMin)),
        Object.keys(this.countries).forEach(
          function (l) {
            var t = document.getElementById(this.id + "-map-country-" + l);
            t &&
              (L.values[l]
                ? ((l = Math.max(o, parseInt(L.values[l][L.applyData], 10))),
                  (l = Math.max(0, Math.min(1, (l - o) / (a - o)))),
                  (l = this.getColor(
                ...
                : t.setAttribute("fill", this.options.colorNoData));
          }.bind(this)
        );
    }),
    ...
    (l.prototype.createMap = function () {
      ...
      var l = this.createElement(
        ...
        L = this.createElement("div", "svgMap-map-controls-zoom", l);
      ["in", "out"].forEach(
        function (l) {
        ...
        Object.keys(l).forEach(
          function (l) {
            ...
            t.d &&
              ...
              L.setAttribute("id", this.id + "-map-country-" + l),
              L.setAttribute("data-id", l),
              L.classList.add("svgMap-country"),
              this.mapImage.appendChild(L),
              ["mouseenter", "touchdown"].forEach(
                function (l) {
                  L.addEventListener(
                    l,
                    function () {
                      L.closest("g").appendChild(L);
                    }.bind(this),
                    { passive: !0 }
                  );
                }.bind(this)
              ...
              void 0 !== this.options.data.values[l] &&
                void 0 !== this.options.data.values[l].link &&
                (L.setAttribute("data-link", this.options.data.values[l].link),
                L.addEventListener("click", function (l) {
                  window.location.href = L.getAttribute("data-link");
                })),
      ...
      (this.mapPanZoom = t(this.mapImage, {
        ...
        beforePan: function (l, t) {
          var L = 0.85 * h.mapWrapper.offsetWidth,
            a = 0.85 * h.mapWrapper.offsetHeight,
            o = this.getSizes(),
            i = -((o.viewBox.x + o.viewBox.width) * o.realZoom) + L,
            e = o.width - L - o.viewBox.x * o.realZoom,
            L = -((o.viewBox.y + o.viewBox.height) * o.realZoom) + a,
            o = o.height - a - o.viewBox.y * o.realZoom;
          return {
            x: Math.max(i, Math.min(e, t.x)),
            y: Math.max(L, Math.min(o, t.y)),
          };
        },
      })),
    ...
    (l.prototype.getTooltipContent = function (L) {
      ...
      !1 === this.options.hideFlag &&
        ...
        "image" === this.options.flagType
          ? this.createElement("img", "svgMap-tooltip-flag", t).setAttribute(
              "src",
              this.options.flagURL.replace("{0}", L.toLowerCase())
            )
          : "emoji" === this.options.flagType &&
            (t.innerHTML = this.emojiFlags[L])),
        (this.createElement("div", "svgMap-tooltip-title", l).innerHTML =
          this.getCountryName(L));
      var a,
            ...
            Object.keys(this.options.data.data).forEach(
              function (l) {
                var t = this.options.data.data[l],
                  l = this.options.data.values[L][l];
    ...
    (l.prototype.getColor = function (l, t, L) {
      (l = l.slice(-6)), (t = t.slice(-6)), (L = parseFloat(L).toFixed(1));
      var a = Math.ceil(
          parseInt(l.substring(0, 2), 16) * L +
            parseInt(t.substring(0, 2), 16) * (1 - L)
        ),
        o = Math.ceil(
          parseInt(l.substring(2, 4), 16) * L +
            parseInt(t.substring(2, 4), 16) * (1 - L)
        ),
        L = Math.ceil(
          parseInt(l.substring(4, 6), 16) * L +
            parseInt(t.substring(4, 6), 16) * (1 - L)
        );
      return "#" + this.getHex(a) + this.getHex(o) + this.getHex(L);
    }),
...
!(function (t, L) {
  "function" == typeof define && define.amd
    ...
    ? (module.exports = t.svgMap = L(require("svg-pan-zoom")))
    : (t.svgMap = L(t.svgPanZoom));
})(this, function (l) {
