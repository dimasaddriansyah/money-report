var Datepicker = (function () {
  ...
  function q(t, s) {
    ...
    if (a.language) {
      ...
      if (
        ...
        o = n.language = e;
        const t = c || r[T];
        (c = Object.assign({ format: H, weekStart: $ }, r[T])),
    ...
    if (void 0 !== a.weekStart) {
      ...
      isNaN(e) || ((g = n.weekStart = e), (n.weekEnd = j(e))),
        delete a.weekStart;
    }
    if (
    ...
    let D = p;
    void 0 !== a.pickLevel && ((D = P(a.pickLevel, 2)), delete a.pickLevel),
      D !== p && (p = n.pickLevel = D);
    let v = u;
    void 0 !== a.maxView && ((v = P(a.maxView, u)), delete a.maxView),
  ...
  class Z extends z {
    ...
    updateSelection() {
      const { dates: e, rangepicker: t } = this.picker.datepicker;
      (this.selected = e.reduce((e, t) => i(e, g(t, this.step)), [])),
        t &&
          t.dates &&
          (this.range = t.dates.map((e) => {
  ...
  class ce {
    ...
    place() {
      ...
      a === document.body
        ...
        "auto" === w &&
          (m < 0
            ? ((w = "left"), (m = 10))
            : (w = m + n > c ? "right" : "rtl" === oe(s) ? "right" : "left")),
        "right" === w && (m -= n - u),
        "auto" === y && (y = g - r < p ? "bottom" : "top"),
        "top" === y ? (g -= r) : (g += f),
        e.remove(
    ...
    changeFocus(e) {
      return (
        (this._renderMethod = de(this, e) ? "render" : "refreshFocus"),
    ...
    update() {
      ...
      return (
        (this._renderMethod = de(this, e) ? "render" : "refresh"),
        this.views.forEach((e) => {
