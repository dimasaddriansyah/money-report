  ...
  return (
    <div>
      <section className="mx-4 mt-4 mb-6">
        <div className="bg-white/10 p-4 rounded-2xl flex flex-col gap-5">
          <div className="flex justify-between">
            ...
            <div
              ...
              className="px-2 text-sm font-medium flex items-center rounded-lg gap-2 border text-amber-500 hover:bg-amber-50 cursor-pointer"
            >
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between">
              <div className="text-xs space-x-1">
                ...
                <span className="text-white/40">terpakai</span>
              </div>
              <span
