...
const ACCOUNT_STYLE_MAP: Record<string, string[]> = {
  ...
  "bg-blue-50 border border-blue-200 text-blue-500": ["bca","mandiri"],
  "bg-cyan-50 border border-cyan-200 text-cyan-500": ["blu by bca"],
  "bg-amber-50 border border-amber-200 text-amber-500": ["e-money mandiri", "tapcash bni", "seabank"],
  "bg-green-50 border border-green-200 text-green-500": ["bibit"],
  "bg-red-50 border border-red-200 text-red-500": ["cimb"]
};
